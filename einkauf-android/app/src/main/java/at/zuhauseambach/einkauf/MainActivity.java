...
public class MainActivity extends Activity {
  ...
  private final String[] brands={"Backbox","Zurück zum Ursprung Bio-Toast","Milsani Irische Butter","Darbo","Natur aktiv","Ich bin Österreich","Ich bin Österreich Bratenaufschnitt","Schärdinger Mondseer","Zurück zum Ursprung","GAZI Ciftlik Naturjoghurt","Schärdinger Formil Vollmilch","Happy Day","Tchibo Feine Milde","Westminster","Obstangebot","Ich bin Österreich Rispentomaten","BILLA immer gut","Gösser NaturWeizen"};
